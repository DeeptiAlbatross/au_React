...
const services = () => {
  return (
    ...
    <div id="services" className="flex justify-center gap-20 bg-gray-200 pt-10">
      ...
      <div className=" pt-20">
        <p className="flex justify-center w-[800px] text-left text-gray-400">
    ...
    <div className=" w-[1200px] flex-row  text-left center grid grid-cols-4">
        {servicesData?.map((i, index) => (
          <div key={index} className={`m-4 p-8  rounded-lg border ${i.style}  border-gray-400  h-72 shadow-md`}  >
            <div>
